...
def draw_rectangle(event, x, y, flags, param):
    global ix, iy, drawing, rectangles, current_room_index, img
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if current_room_index < len(rooms_data):
            print(f"Next room: {rooms_data[current_room_index]['room_number']}")
        else:
            print("All rooms processed. Press 'q' to save and exit.")
            save_annotations()
